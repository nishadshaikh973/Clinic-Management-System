...
{
$sql=mysqli_query("update  doctorSpecilization set specilization='".$_POST['doctorspecilization']."', updationDate='$currentTime'where id='$id'");
...
$id=intval($_GET['id']);
	$sql=mysqli_query("select * from doctorSpecilization where id='$id'");
